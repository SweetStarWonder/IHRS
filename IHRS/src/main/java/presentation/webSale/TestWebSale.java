...
public class TestWebSale extends Application{
	...
	public void initRoot() {
		...
		loader.setLocation(TestWebSale.class.getResource("init/WebSaleRootLayout.fxml"));
		try {
	...
	public void showMenuPane() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("init/WebSaleMenuPane.fxml"));
	...
	public void showRankGrade() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("rank/RankPane.fxml"));
		AnchorPane anchorPane;
		try {
			anchorPane = (AnchorPane) loader.load();
	...
	public void showPromotion() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("promotion/WebPromotionListView.fxml"));
		AnchorPane anchorPane;
		try {
			anchorPane = (AnchorPane) loader.load();
			changeView(anchorPane);
	...
	public void addTimePromotionPane() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("promotion/AddTimePromotionDialog.fxml"));
	...
	public void addNormalVipPromotionPane() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("promotion/AddNormalVipPromotionDialog.fxml"));
		AnchorPane anchorPane = null;
		try {
			anchorPane = (AnchorPane) loader.load();
		} catch (IOException e) {
	...
	public void showList() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("list/ListView.fxml"));
		SplitPane splitPane;
		try {
	...
	public void selectRevoke() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("list/RevokeSelectPane.fxml"));
		AnchorPane anchorPane = null;
		try {
			anchorPane = (AnchorPane) loader.load();
		} catch (IOException e) {
	...
	public void showRechargePane() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("recharge/CreditRechargePane.fxml"));
		AnchorPane anchorPane;
		try {
			anchorPane = (AnchorPane) loader.load();
			changeView(anchorPane);
	...
	public void inputMoneyDialog() {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(TestWebSale.class.getResource("recharge/RechargeMoneyPane.fxml"));
		AnchorPane anchorPane = null;
		try {
			anchorPane = (AnchorPane) loader.load();
		} catch (IOException e) {
