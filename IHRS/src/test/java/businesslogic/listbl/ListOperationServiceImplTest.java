...
public class ListOperationServiceImplTest {
	...
	public void revokeListTest() {
		...
		ListVO listVOtest = new ListVO(1, 11, 111, status, "2016/10/01 11:00:00", "2016/10/01 12:00:00",
				"2016/10/01 13:00:00", 1111, true, roomvolist);
		...
		assertEquals(ListStatus.REVOKED,
				ListOperationServiceImpl.revokeList(listVOtest, "2016/10/01 13:00:00").getStatus());
		assertEquals("2016/10/01 11:00:00",
				ListOperationServiceImpl.revokeList(listVOtest, "2016/10/01 13:00:00").getEntryTime());
		assertEquals("2016/10/01 12:00:00",
				ListOperationServiceImpl.revokeList(listVOtest, "2016/10/01 13:00:00").getLastTime());
		assertEquals("2016/10/01 13:00:00",
				ListOperationServiceImpl.revokeList(listVOtest, "2016/10/01 13:00:00").getLastListExecutedTime());
	...
	public void updateCheckInTest() {
		...
		assertEquals(ListStatus.EXECUTED,
				ListOperationServiceImpl.updateCheckIn(listVOtest, "2016/10/01 13:00:00").getStatus());
		assertEquals("2016/10/01 13:00:00",
				ListOperationServiceImpl.updateCheckIn(listVOtest, "2016/10/01 13:00:00").getEntryTime());
		assertEquals("2016/10/01 11:00:00",
				ListOperationServiceImpl.updateCheckIn(listVOtest, "2016/10/01 13:00:00").getLastTime());
		assertEquals("2016/10/01 12:00:00",
				ListOperationServiceImpl.updateCheckIn(listVOtest, "2016/10/01 13:00:00").getLastListExecutedTime());
	...
	public void updateCheckOutTest() {
		...
		assertEquals("ABNORMAL",
				ListOperationServiceImpl.updateCheckOut(listVOtest, "2016/10/01 13:00:00").getStatus());
		assertEquals("2016/10/01 10:00:00",
				ListOperationServiceImpl.updateCheckOut(listVOtest, "2016/10/01 13:00:00").getEntryTime());
		assertEquals("2016/10/01 13:00:00",
				ListOperationServiceImpl.updateCheckOut(listVOtest, "2016/10/01 13:00:00").getLastTime());
		assertEquals("2016/10/01 12:00:00",
				ListOperationServiceImpl.updateCheckOut(listVOtest, "2016/10/01 13:00:00").getLastListExecutedTime());
	...
	public void executeListTest() {
		...
		assertEquals("2016/10/01 10:00:00",
				ListOperationServiceImpl.executeList(listVOtest, "2016/10/01 13:00:00").getEntryTime());
		assertEquals("2016/10/01 11:00:00",
				ListOperationServiceImpl.executeList(listVOtest, "2016/10/01 13:00:00").getLastTime());
		assertEquals("2016/10/01 12:00:00",
				ListOperationServiceImpl.executeList(listVOtest, "2016/10/01 13:00:00").getLastListExecutedTime());
	...
	public void setAbnormalTest() {
		...
		assertEquals("2016/10/01 10:00:00",
				ListOperationServiceImpl.setAbnormal(listVOtest, "2016/10/01 13:00:00").getEntryTime());
		assertEquals("2016/10/01 11:00:00",
				ListOperationServiceImpl.setAbnormal(listVOtest, "2016/10/01 13:00:00").getLastTime());
		assertEquals("2016/10/01 12:00:00",
				ListOperationServiceImpl.setAbnormal(listVOtest, "2016/10/01 13:00:00").getLastListExecutedTime());
	...
	public void revokeAbnormalList() {
		...
		ListVO listVOtest = new ListVO(1, 11, 111, status, "2016/10/01 11:00:00", "2016/10/01 12:00:00",
				"2016/10/01 13:00:00", 1111, true, roomvolist);
		assertEquals(1,
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getListId());
		assertEquals(11,
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getHotelId());
		assertEquals(111,
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getUserId());
		assertEquals("REVOKED",
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getStatus());
		assertEquals("2016/10/01 10:00:00",
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getEntryTime());
		assertEquals("2016/10/01 11:00:00",
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getLastTime());
		assertEquals("2016/10/01 13:00:00", ListOperationServiceImpl
				.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getLastListExecutedTime());
		assertEquals(1111,
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).getPrice());
		assertEquals(true,
				ListOperationServiceImpl.revokeAbnormalList(listVOtest, "2016/10/01 13:00:00", true).isIfHaveChild());
