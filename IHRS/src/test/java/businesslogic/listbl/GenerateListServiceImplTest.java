...
public class GenerateListServiceImplTest {
	...
	public void testgenerateList1() {
		// ListPO listPO = new ListPO(1111, 2222, 1234, ListStatus.ABNORMAL,
		// "2016/10/01 08:00:00", "2016/10/01 10:00:00", "2016/10/01 10:00:01",
		// 500, true);
		...
		roomVOs.add(roomVO);
		ListVO listVO = new ListVO(1111, 2222, 1234, ListStatus.ABNORMAL, "2016/10/01 08:00:00", "2016/10/01 10:00:00",
				"2016/10/01 10:00:01", 500, true, roomVOs);
