...
public class HotelOperationServiceImplTest {
	...
	public void testaddHotel() {
		...
		HotelVO hotelVO = new HotelVO(8888, null, null, partners, null, "hotelName", "position", "businessDistrict", 4,
				"introduction", "facility", 5);
	...
	public void testevaluateHotel() {
		...
		HotelVO hotelVO = new HotelVO(new HotelPO(8888, partners, "hotelName", "position", "businessDistrict", 4,
